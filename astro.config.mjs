			...
			[
				rehypeComponents,
				{
					components: {
						...
						ci: ClassBox("ci"),
						// 新增：把 :::spellcard / :::poem / :::waka 映射为同名 div
						spellcard: ClassBox("spellcard"),
						poem: ClassBox("poem"),
						poem_ong: ClassBox("poem poem_ong"),
						poem_en: ClassBox("poem poem_en"),
						waka: ClassBox("waka"),
						// 新增：行内字体指令，例如 :ong[Linselotte Guenther]
						ja: FontSpan("ff-ja"),
						zh_cn: FontSpan("ff-zh_cn"),
						ja_old: FontSpan("ff-ja_old"),
						ong: FontSpan("ff-ong"),
						cjk_old: FontSpan("ff-cjk_old"),
